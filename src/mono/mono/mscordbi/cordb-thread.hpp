...
public:
    ...
    HRESULT STDMETHODCALLTYPE GetBlockingObjects(/* [out] */ ICorDebugBlockingObjectEnum** ppBlockingObjectEnum);
    HRESULT STDMETHODCALLTYPE GetCurrentCustomDebuggerNotification(/* [out] */ ICorDebugValue** ppNotificationObject);
    HRESULT STDMETHODCALLTYPE CreateStackWalk(/* [out] */ ICorDebugStackWalk** ppStackWalk);
    HRESULT STDMETHODCALLTYPE GetActiveInternalFrames(/* [in] */ ULONG32 cInternalFrames,/* [out] */ ULONG32* pcInternalFrames,/* [length_is][size_is][out][in] */ ICorDebugInternalFrame2* ppInternalFrames[]);
    HRESULT STDMETHODCALLTYPE GetActiveFunctions(/* [in] */ ULONG32 cFunctions,/* [out] */ ULONG32* pcFunctions,/* [length_is][size_is][out][in] */ COR_ACTIVE_FUNCTION pFunctions[]);
    HRESULT STDMETHODCALLTYPE GetConnectionID(/* [out] */ CONNID* pdwConnectionId);
    HRESULT STDMETHODCALLTYPE GetTaskID(/* [out] */ TASKID* pTaskId);
    HRESULT STDMETHODCALLTYPE GetVolatileOSThreadID(/* [out] */ DWORD* pdwTid);
    HRESULT STDMETHODCALLTYPE InterceptCurrentException(/* [in] */ ICorDebugFrame* pFrame);
    ...
    HRESULT STDMETHODCALLTYPE GetDebugState(/* [out] */ CorDebugThreadState* pState);
    HRESULT STDMETHODCALLTYPE GetUserState(/* [out] */ CorDebugUserState* pState);
    HRESULT STDMETHODCALLTYPE GetCurrentException(/* [out] */ ICorDebugValue** ppExceptionObject);
    ...
    HRESULT STDMETHODCALLTYPE EnumerateChains(/* [out] */ ICorDebugChainEnum** ppChains);
    HRESULT STDMETHODCALLTYPE GetActiveChain(/* [out] */ ICorDebugChain** ppChain);
